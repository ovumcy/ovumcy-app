...
const dayLogCopyEn = {
  ...
  weight: "Weight",
  weightUnit: "kg",
  weightHint: "Optional weight reading for today, while pregnancy tracking is active.",
  bloodPressure: "Blood pressure",
  bloodPressureUnit: "mmHg",
  bloodPressureHint:
    "Optional blood pressure reading for today, while pregnancy tracking is active.",
  bloodPressureSystolicPlaceholder: "Systolic",
  bloodPressureDiastolicPlaceholder: "Diastolic",
  notes: "Notes",
...
const dayLogCopyDe: DayLogCopy = {
  ...
  weightUnit: "kg",
  weightHint:
    "Optionaler Gewichtswert für heute, solange die Schwangerschaftsverfolgung aktiv ist.",
  bloodPressure: "Blutdruck",
  bloodPressureUnit: "mmHg",
  bloodPressureHint:
    "Optionaler Blutdruckwert für heute, solange die Schwangerschaftsverfolgung aktiv ist.",
  bloodPressureSystolicPlaceholder: "Systolisch",
  bloodPressureDiastolicPlaceholder: "Diastolisch",
  notes: "Notizen",
...
const dayLogCopyFr: DayLogCopy = {
  ...
  weightUnit: "kg",
  weightHint:
    "Relevé de poids facultatif pour aujourd'hui, tant que le suivi de grossesse est actif.",
  bloodPressure: "Tension artérielle",
  bloodPressureUnit: "mmHg",
  bloodPressureHint:
    "Relevé de tension artérielle facultatif pour aujourd'hui, tant que le suivi de grossesse est actif.",
  bloodPressureSystolicPlaceholder: "Systolique",
  bloodPressureDiastolicPlaceholder: "Diastolique",
  notes: "Notes",
...
const dayLogCopyCatalog: Record<InterfaceLanguage, DayLogCopy> = {
  ...
  ru: {
    ...
    weightUnit: "кг",
    weightHint:
      "Необязательное значение веса за сегодня, пока активно отслеживание беременности.",
    bloodPressure: "Давление",
    bloodPressureUnit: "мм рт. ст.",
    bloodPressureHint:
      "Необязательное значение давления за сегодня, пока активно отслеживание беременности.",
    bloodPressureSystolicPlaceholder: "Систолическое",
    bloodPressureDiastolicPlaceholder: "Диастолическое",
    notes: "Заметки",
  ...
  es: {
    ...
    weightUnit: "kg",
    weightHint:
      "Lectura de peso opcional para hoy, mientras el seguimiento del embarazo esté activo.",
    bloodPressure: "Tensión arterial",
    bloodPressureUnit: "mmHg",
    bloodPressureHint:
      "Lectura de tensión arterial opcional para hoy, mientras el seguimiento del embarazo esté activo.",
    bloodPressureSystolicPlaceholder: "Sistólica",
    bloodPressureDiastolicPlaceholder: "Diastólica",
    notes: "Notas",
  ...
  it: {
    ...
    subtitle:
      "Registra cosa è successo oggi senza uscire dal tuo contesto local-first del ciclo.",
    periodDay: "Giorno di ciclo",
    symptoms: "Sintomi",
    mood: "Umore",
    cycleFactors: "Fattori del ciclo",
    cycleFactorsHint:
      "Tag di contesto facoltativi per elementi che possono influenzare il timing di questo ciclo.",
    flow: "Flusso",
    intimacy: "Intimità",
    cervicalMucus: "Muco cervicale",
    cervicalMucusExplainer:
      "Il muco cervicale indica le perdite vaginali. Il muco a consistenza di albume d'uovo appare spesso vicino al picco di fertilità.",
    lhTest: "Test LH",
    lhTestHint: "Risultato facoltativo dello stick di ovulazione per oggi.",
    pregnancyTest: "Test di gravidanza",
    pregnancyTestHint:
      "Risultato facoltativo di un test di gravidanza casalingo. Un risultato positivo sospende le previsioni del ciclo.",
    bbt: "BBT",
    bbtHint: "Inserisci una rilevazione della temperatura basale per oggi.",
    weight: "Peso",
    weightUnit: "kg",
    weightHint:
      "Rilevazione del peso facoltativa per oggi, mentre il monitoraggio della gravidanza è attivo.",
    bloodPressure: "Pressione",
    bloodPressureUnit: "mmHg",
    bloodPressureHint:
      "Rilevazione della pressione facoltativa per oggi, mentre il monitoraggio della gravidanza è attivo.",
    bloodPressureSystolicPlaceholder: "Sistolica",
    bloodPressureDiastolicPlaceholder: "Diastolica",
    notes: "Note",
    showMoreSymptoms: "Altri sintomi",
    showFewerSymptoms: "Meno sintomi",
    notesPlaceholder: "Qualsiasi cosa tu voglia ricordare di oggi.",
    saveToday: "Salva oggi",
    updateEntry: "Aggiorna voce",
    saveDay: "Salva voce",
    saving: "Salvataggio locale...",
    saved: "Voce salvata localmente.",
    saveFailed: "Impossibile salvare questa voce. Riprova.",
    deleteEntry: "Cancella voce",
    deleted: "Voce rimossa localmente.",
    deleteFailed: "Impossibile cancellare questa voce. Riprova.",
    deletePrompt:
      "Cancellare questa voce per questo giorno? Ciclo, sintomi, umore, flusso e note verranno rimossi dal record locale.",
    ...
    options: {
      mood: [
        ...
        { value: 2, label: "🙁", secondaryLabel: "Male" },
        { value: 3, label: "😌", secondaryLabel: "Così così" },
        { value: 4, label: "🙂", secondaryLabel: "Bene" },
        { value: 5, label: "🤩", secondaryLabel: "Benissimo" },
      ],
      flow: [
      ...
      sexActivity: [
        ...
        { value: "protected", label: "Protetto" },
        { value: "unprotected", label: "Non protetto" },
      ],
      cervicalMucus: [
        { value: "none", label: "Nessuno" },
        { value: "dry", label: "Secco" },
        { value: "moist", label: "Umido" },
        { value: "creamy", label: "Cremoso" },
        { value: "eggwhite", label: "Albume d'uovo" },
      ],
      lhTest: [
        { value: "none", label: "Nessun test" },
        { value: "negative", label: "Negativo" },
        { value: "high", label: "Alto" },
        { value: "peak", label: "Picco" },
      ],
      pregnancyTest: [
        { value: "none", label: "Nessun test" },
        { value: "negative", label: "Negativo" },
      ...
      cycleFactors: {
        stress: { label: "Stress", icon: "⚡" },
        illness: { label: "Malattia", icon: "🤒" },
        travel: { label: "Viaggio", icon: "✈️" },
        sleep_disruption: { label: "Disturbi del sonno", icon: "🌙" },
        medication_change: { label: "Cambio di farmaco", icon: "💊" },
      },
    },
  },
  de: dayLogCopyDe,
