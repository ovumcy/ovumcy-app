...
const dashboardCopyCatalog: Record<InterfaceLanguage, DashboardCopy> = {
  ...
  ru: {
    ...
    quickActions: {
      ...
      period: "Быстро отметить день менструации",
      symptom: "Быстро отметить симптом",
    },
  ...
  es: {
    ...
    quickActions: {
      mood: "Registrar ánimo rápido",
      period: "Marcar día de período",
      symptom: "Registrar un síntoma",
    },
