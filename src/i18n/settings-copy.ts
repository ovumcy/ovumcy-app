...
const settingsCopyEn = {
  ...
  import: {
    ...
    previewPregnanciesTemplate: "New pregnancy records: %d",
    previewKickSessionsTemplate: "New kick-count sessions: %d",
    previewContractionSessionsTemplate: "New contraction sessions: %d",
    previewPostpartumRecordsTemplate: "New postpartum records: %d",
    previewScreeningResponsesTemplate: "New check-ins: %d",
...
const settingsCopyDe: SettingsCopy = {
  ...
  import: {
    ...
    previewPregnanciesTemplate: "Neue Schwangerschaftseinträge: %d",
    previewKickSessionsTemplate: "Neue Tritt-Zähler-Sitzungen: %d",
    previewContractionSessionsTemplate: "Neue Wehen-Sitzungen: %d",
    previewPostpartumRecordsTemplate: "Neue Wochenbett-Einträge: %d",
    previewScreeningResponsesTemplate: "Neue Check-ins: %d",
    previewProfileRestore:
...
const settingsCopyFr: SettingsCopy = {
  ...
  import: {
    ...
    previewPregnanciesTemplate: "Nouvelles grossesses enregistrées : %d",
    previewKickSessionsTemplate: "Nouvelles séances de comptage des mouvements : %d",
    previewContractionSessionsTemplate: "Nouvelles séances de contractions : %d",
    previewPostpartumRecordsTemplate: "Nouveaux enregistrements post-partum : %d",
    previewScreeningResponsesTemplate: "Nouveaux points : %d",
    previewProfileRestore:
...
const settingsCopyCatalog: Record<InterfaceLanguage, SettingsCopy> = {
  ...
  ru: {
    ...
    import: {
      ...
      previewPregnanciesTemplate: "Новых записей о беременности: %d",
      previewKickSessionsTemplate: "Новых сессий подсчёта шевелений: %d",
      previewContractionSessionsTemplate: "Новых сессий схваток: %d",
      previewPostpartumRecordsTemplate: "Новых послеродовых записей: %d",
      previewScreeningResponsesTemplate: "Новых проверок: %d",
      previewProfileRestore:
  ...
  es: {
    ...
    import: {
      ...
      previewPregnanciesTemplate: "Nuevos registros de embarazo: %d",
      previewKickSessionsTemplate: "Nuevas sesiones de conteo de pataditas: %d",
      previewContractionSessionsTemplate: "Nuevas sesiones de contracciones: %d",
      previewPostpartumRecordsTemplate: "Nuevos registros posparto: %d",
      previewScreeningResponsesTemplate: "Nuevas pausas: %d",
      previewProfileRestore:
  ...
  it: {
    ...
    import: {
      ...
      previewPregnanciesTemplate: "Nuove gravidanze registrate: %d",
      previewKickSessionsTemplate: "Nuove sessioni di conteggio dei calci: %d",
      previewContractionSessionsTemplate: "Nuove sessioni di contrazioni: %d",
      previewPostpartumRecordsTemplate: "Nuovi record post-partum: %d",
      previewScreeningResponsesTemplate: "Nuovi momenti: %d",
      previewProfileRestore:
